...
<body>
    <h1 class="heading">Update Marks</h1>
    <div class="Form">
        <form name="myform" method="post" action="updatemarks.php" onsubmit = "return validateForm();">   
        ...
        if(isset($_POST['submit']))
        {
            ...
            if(!($row==NULL)){
                ...
                echo "<div style='color:red;text-shadow:0px 0px 2px; text-align:center;'>This test was not taken</div>";   
            }
